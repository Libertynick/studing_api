from UI_homework.frontend_tests_lesson.src.frontend.services.shop.elements.navbar_element.navbar_element import NavbarElement
from UI_homework.frontend_tests_lesson.src.frontend.services.shop.pages.catalog_page.models import Good
